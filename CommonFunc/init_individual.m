function [population,innovation_record] = init_individual(PopSize,vector_connected_input_nodes,number_input_nodes,number_output_nodes,ObjNum)
...
for index_individual = 1:PopSize
    ...
    population(index_individual).Obj = inf*ones(1,ObjNum);
