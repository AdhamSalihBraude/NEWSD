function [Newindividuals,updated_innovation_record,updated_TopologyTracker] = reproduceTopologies(crossover ,mutation, TopologyTracker ,innovation_record, GenCounter,mating_pool,PopSize,MaxTopologeis)
